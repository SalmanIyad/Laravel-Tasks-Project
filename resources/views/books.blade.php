    ...
    <div class="overflow-x-auto shadow rounded-lg">
        <table class="w-full bg-white">
            ...
            <tbody>
                @forelse($books as $book)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm space-x-2">
                            <a href="/books/{{ $book->id }}/edit" class="text-yellow-500 hover:text-yellow-700 font-semibold cursor-pointer">Edit</a>
                ...
                @empty
                    <tr> <td colspan="3" class="px-6 py-4 text-center text-gray-500">No books found. Add some!</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
